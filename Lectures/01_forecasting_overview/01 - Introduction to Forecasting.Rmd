...
\footnotetext{The printed numbers from my computations had a starting date of `r format(max_date, format = '%B %d, %Y')` and a current date of `r format(max_date, format = '%B %d, %Y')`. Thus, the numbers will change (slightly) unless we use the same ending date for our calculations.}
