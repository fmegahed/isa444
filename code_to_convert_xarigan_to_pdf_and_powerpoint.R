...
renderthis::to_pdf(from = 'lectures/05_ts_summary/05_ts_summary.html',
                   to = 'pdfs/05_ts_summary.pdf',
                   complex_slides = TRUE,
                   partial_slides = TRUE,
                   delay = 1)

# I am using my adobe to create the ppt since the text is editable (which is more preferable to students)
renderthis::to_pptx(from = 'lectures/05_ts_summary/05_ts_summary.html',
                    to = 'ppts/05_ts_summary.pptx',
                    complex_slides = TRUE,
                    partial_slides = TRUE,
                    delay = 1)
