...
renderthis::to_pdf(from = 'lectures/25_ts_reg/25_ts_reg.html',
                   to = 'pdfs/25_ts_reg.pdf',
                   complex_slides = TRUE,
                   partial_slides = TRUE,
                   delay = 1)

# I am using my adobe to create the ppt since the text is editable (which is more preferable to students)
renderthis::to_pptx(from = 'lectures/25_ts_reg/25_ts_reg.html',
                    to = 'ppts/25_ts_reg.pptx',
                    complex_slides = TRUE,
                    partial_slides = TRUE,
                    delay = 1)
