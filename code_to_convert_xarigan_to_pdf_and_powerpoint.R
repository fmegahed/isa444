...
renderthis::to_pdf(from = 'lectures/02_introduction_to_r/02_intro_r.html',
                   to = 'pdfs/02_intro_r.pdf',
                   complex_slides = TRUE,
                   partial_slides = TRUE,
                   delay = 2)

# I am using my adobe to create the ppt since the text is editable (which is more preferable to students)
renderthis::to_pptx(from = 'lectures/02_introduction_to_r/02_intro_r.html',
                    to = 'ppts/02_intro_r.pptx',
                    complex_slides = TRUE,
                    partial_slides = TRUE,
                    delay = 2)
