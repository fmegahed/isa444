...
```{r forecast, out.height='400px', out.width='800px', echo=FALSE, cache=FALSE}
...
```{r hotel_bookings, echo=FALSE, cache=FALSE, out.height='500px', out.width='100%'}
...
```{r timeseries2, out.height='400px', out.width='900px', echo=FALSE, cache=FALSE}
...
```{r trendUP, out.height='400px', out.width='900px', echo=FALSE, cache=FALSE}
...
```{r trendDown, out.height='400px', out.width='900px', echo=FALSE, cache=FALSE}
...
```{r hoteplot2, out.height='400px', out.width='900px', echo=FALSE, cache=FALSE}
plotly::ggplotly(
  hotel_plot,
  tooltip = c("x", "y", "color")
)
...
```{r autoSales, out.height='400px', out.width='900px', echo=FALSE, cache=FALSE}
...
- Go over your notes and complete [Assignment 01](https://miamioh.instructure.com/courses/188655/quizzes/531534/) on Canvas.  

- Read through [Chapter 01 of our reference book](https://cdn.shopify.com/s/files/1/0859/4364/files/Part_I_POBF-_A_First_Course_in_Forecasting_1.pdf?612) and skim the following: 
