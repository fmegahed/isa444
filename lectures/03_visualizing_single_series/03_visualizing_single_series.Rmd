...
.panel[.panel-name[Description]
  ...
  - **Dataset**: Load Apple's iPhone revenue data from 2007 to 2025. Click [here](https://miamioh.instructure.com/courses/240425/files/36520202?module_item_id=6193334) to download the data.  
...
apple_rev = (
  pd.read_csv("../../data/statistic_id263402_apple-iphone-sales-revenue-2007-2025.csv")
  .assign(
    date = lambda x: pd.to_datetime(x['date']),
    quarter = lambda x: x['date'].dt.quarter,
    year = lambda x: x['date'].dt.year,
