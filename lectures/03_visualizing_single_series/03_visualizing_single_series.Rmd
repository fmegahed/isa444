...
- Since Q1 2009, **Windows' Mobile OS's market share <= 2.5%**, and is now at 0.02% ([StatCounter](https://gs.statcounter.com/os-market-share/mobile/worldwide/#quarterly-200901-202503)).

- **Apple's Mobile iOS market share > 19%**, and is now at **26.63%** ([StatCounter](https://gs.statcounter.com/os-market-share/mobile/worldwide/#quarterly-200901-202503)).

- Apple's **iPhone revenues** from 2007 to 2025 was **$2.106 trillion** (per [statista](https://www.statista.com/statistics/263402/apples-iphone-revenue-since-3rd-quarter-2007/)).

- Assuming Microsoft could have captured just **5%** of Apple's market revenue $\rightarrow$ **$105 billion**.
...
mshare = pd.read_csv("../../data/os_combined-ww-quarterly-20091-20253.csv")
...
ax = mshare.plot(
    ...
    alpha=0.7,
    linewidth=2,
    title="Mobile OS Market Share for Windows, iOS and Android (2009 - 2025)",
    xlabel="Date (Years)",
    ylabel="Market Share (%)",
    grid=True
)
...
apple_rev = pd.read_csv("https://raw.githubusercontent.com/fmegahed/isa444/refs/heads/main/data/statistic_id263402_apple-iphone-sales-revenue-2007-2025.csv")
...
.panel[.panel-name[Description]
  ...
  - **Dataset**: Load Apple's iPhone revenue data from 2007 to 2025. Click [here](https://raw.githubusercontent.com/fmegahed/isa444/refs/heads/main/data/statistic_id263402_apple-iphone-sales-revenue-2007-2025.csv) to download the data.  
...
- **With Fadel** We will use [querychat](https://posit-dev.github.io/querychat/) to explore the data.
...
<div style='position: relative; padding-bottom: 56.25%; padding-top: 35px; height: 0; overflow: hidden;'><iframe sandbox='allow-scripts allow-same-origin allow-presentation' allowfullscreen='true' allowtransparency='true' frameborder='0' height='245' src='https://www.mentimeter.com/app/presentation/alnkn25ebq2843izdhvj87uw5yjjky33/embed' style='position: absolute; top: 0; left: 0; width: 100%; height: 100%;' width='420'></iframe></div>
...
Use the [Pandas Plot API](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.plot.html) to create a simple line chart of Apple's iPhone revenues from 2007 to 2025.  
...
ax.set_title("Apple's iPhone Revenues (2007 - 2025)")
ax.set_xlabel("Date")
...
apple_rev = (
  pd.read_csv("https://raw.githubusercontent.com/fmegahed/isa444/refs/heads/main/data/statistic_id263402_apple-iphone-sales-revenue-2007-2025.csv")
  .assign(
    date = lambda x: pd.to_datetime(x['date']),
    quarter = lambda x: x['date'].dt.quarter,
    year = lambda x: x['date'].dt.year,
